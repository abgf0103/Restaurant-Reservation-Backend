...
public class ReviewServiceImpl implements ReviewService {
    ...
    public Long getRankingByLikes(Long userId) {
        ...
        if (userLikes != null && userLikes > 0) {
            ...
            return reviewMapper.getRankingByLikes(userLikes);  // 해당 사용자의 랭킹 반환
        }
    ...
    @Override
    public Long getUserRankingByLikes(String username) {
        // 해당 사용자가 받은 좋아요 총합을 가져옴
        Long userLikes = reviewMapper.getUserRankingbyLiked(username);
